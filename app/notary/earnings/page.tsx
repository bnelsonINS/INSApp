...
function paymentBadge(status: string | null) {
  ...
  if (status === "Signing Complete") return "bg-amber-100 text-amber-800";
  ...
  return (
    <main className="space-y-6 p-4 sm:p-6">
      <section className="rounded-2xl bg-slate-950 p-6 text-white shadow">
        <p className="text-sm text-slate-300">Notary Payments</p>
        <h1 className="mt-1 text-2xl font-bold sm:text-3xl">Earnings</h1>
        <p className="mt-2 max-w-3xl text-sm text-slate-300">
          Track completed assignment fees, pending payments, and paid work.
        </p>
      </section>

      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-2xl border border-blue-100 bg-blue-50 p-5 shadow-sm">
          <p className="text-sm font-semibold text-blue-700">This Month</p>
          <p className="mt-2 text-4xl font-bold text-blue-950">
            {formatMoney(monthTotal)}
          </p>
          <p className="mt-2 text-xs text-blue-700">Closed assignments</p>
        </div>
        ...
        <div className="rounded-2xl border border-green-100 bg-green-50 p-5 shadow-sm">
          <p className="text-sm font-semibold text-green-700">Paid YTD</p>
          <p className="mt-2 text-4xl font-bold text-green-950">
            {formatMoney(yearTotal)}
          </p>
          <p className="mt-2 text-xs text-green-700">Closed this year</p>
        </div>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-2xl bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex items-center justify-between rounded-xl bg-green-50 p-4">
              <div>
                <p className="font-semibold text-green-900">Paid / Closed</p>
            ...
            <div className="flex items-center justify-between rounded-xl bg-slate-50 p-4">
              <div>
                <p className="font-semibold text-slate-900">Payable Work</p>
              ...
              <p className="text-xl font-bold text-slate-950">
                {formatMoney(
                  payableAssignments.reduce(
                    (sum, assignment) =>
                      sum + moneyValue(assignment.notary_fee),
                    0
                  )
                )}
              </p>
        ...
        <div className="rounded-2xl bg-white p-5 shadow-sm lg:col-span-2">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            <div className="rounded-xl border border-slate-200 p-4">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Assignment has not been closed by title company or waiting on payment.
              </p>
            </div>

            <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
              <p className="font-bold text-amber-950">Pending Payment</p>
              <p className="mt-2 text-sm text-amber-700">
                The signing has been closed. Indiana Notary Solutions is processing your payment.
              </p>
            </div>

            <div className="rounded-xl border border-green-200 bg-green-50 p-4">
              <p className="font-bold text-green-950">Paid / Closed</p>
          ...
          <p className="mt-4 text-sm text-slate-500">
            ...
            notary fee. Please remember, payment will be processed after the title company closes the file.
          </p>
        </div>
      </section>
              ...
              {safeAssignments.map((assignment) => (
                ...
                >
                  ...
                  <a
                    ...
                    className="mt-4 block rounded-xl bg-slate-950 px-4 py-2 text-center text-sm font-semibold text-white hover:bg-slate-800"
                  >
                    View Assignment
                  </a>
                </div>
                ...
                <tbody>
                  {safeAssignments.map((assignment) => (
                    ...
                    >
                      ...
                      <td className="p-3">{assignment.status ?? "Unknown"}</td>
