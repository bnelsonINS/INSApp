    ...
    <PageShell>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-12 grid max-w-7xl gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <FeatureCard icon="🧭" title="Notary Assignment" body="Find approved notaries by coverage, score, metrics, and status so admins can assign confidently." />
          <FeatureCard icon="📨" title="Offer Rounds" body="Send offers, track responses, view accepted offers, and assign the notary that best fits the file." />
          ...
          <FeatureCard icon="🔔" title="Admin Notices" body="Track overdue confirmations, signing milestones, scanback timing, and operational exceptions." />
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-5 text-lg leading-8 text-slate-600">
                INS helps admins monitor assignment progress, notary confirmations, signing status, scanback requirements, and QA readiness from a single operational dashboard.
              </p>
            </div>
